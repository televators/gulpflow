...
function getDevUrl(){
  return `http://${path.resolve('../../..').split("/").reverse()[0]}.test`;
}
...
gulp.task('dist-js', function () {
  gulp.src(['./assets/src/js/countdown.js','./assets/src/js/script.js'])
...
gulp.task('dist-img', function(){
  return gulp.src(['assets/src/images/*.jpg', 'assets/src/mages/*.png', 'assets/src/images/*.svg'])
    .pipe(tasks.newer('assets/dist/images'))
    .pipe(tasks.imagemin())
